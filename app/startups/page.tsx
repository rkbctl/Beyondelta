  ...
  return (
    <>
      <section className="mx-auto w-full max-w-3xl px-6 py-24 text-center">
        <span className="text-xs uppercase tracking-widest text-gold">For early-stage B2B startups</span>
      ...
      <section className="mx-auto w-full max-w-4xl px-6 py-20">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-gold/20 bg-navy p-8">
            <span className="text-xs uppercase tracking-widest text-gold">Phase 1</span>
            <h3 className="mt-2 font-serif text-2xl">PMF Discovery</h3>
            <p className="mt-3 text-sm text-offwhite/60">[Description]</p>
          </div>
          <div className="rounded-2xl border border-gold/20 bg-navy p-8">
            <span className="text-xs uppercase tracking-widest text-gold">Phase 2</span>
      ...
      <section className="mx-auto w-full max-w-3xl px-6 py-20 text-center">
        ...
        <div className="mt-8 rounded-2xl border border-gold/20 bg-navy p-8">
